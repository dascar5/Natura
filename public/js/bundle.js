...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFudGV2biIsImEiOiJja2RoYXplY2cwNm9jMnF1YzI3YzZwNGhsIn0.Pl4SqqROO9Vd1BzjyMWm2Q';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/dantevn/ckdhbcffe117f1iq5krw9tj45',
    scrollZoom: false //   center: [-118.4535089, 34.1240171],
    //   zoom: 10,
    //   interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    }).setLngLat(loc.coordinates).addTo(map); //cita koordinate iz tours
    //dodaj popup
...
//type je ili success ili error
//alert klasa se nalazi u css fajlu, razliciti tipovi razlicite boje
//zelena za success, crvena za error
...
var stripe = Stripe('pk_test_51HGV78D85c4neJaw8FpZrmXk05N03VhZkxY3suGPKA1VDVRKwz4LWCXJI4B9vncZxaFJiGcoLZN5TRdm2KfCRkd800xkr9PUfG');
